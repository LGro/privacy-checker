...
public class AppPermissionRating {
	// Database tableCOMM
		public static final String TABLE = "tbl_app_permission_rating";
		// Columns
		...
		public AppPermissionRating(int id, int value, int appPermissionId, boolean isExpert, String origin){
			this.id = id;
			this.value = value; 
